...
export class EnhancedRPAService {
  ...
  getStepTemplates(): RPAStepTemplate[] {
    return [
      ...
      },
      {
        ...
        type: 'close_tab',
        name: 'Close Tab',
        description: 'Close a tab by index (default last)',
        icon: '✖️',
        color: 'bg-rose-500',
        category: 'Tabs',
        defaultConfig: { tabIndex: -1 },
        configSchema: [
          { key: 'tabIndex', label: 'Tab Index', type: 'number', required: false, placeholder: '-1 (last tab)' }
        ]
      },
      {
        id: 'switch_tab',
        ...
        configSchema: [
          { key: 'tabIndex', label: 'Tab Index', type: 'number', required: true, default: 0 }
        ]
      },
      {
        id: 'refresh',
      ...
      },
      {
        ...
        configSchema: [
          { key: 'selector', label: 'Selector', type: 'text', required: true, placeholder: '.menu-item' }
        ]
      },
      {
        id: 'focus',
        ...
        defaultConfig: { selector: '' },
        configSchema: [
          { key: 'selector', label: 'Selector', type: 'text', required: true, placeholder: 'input[name="q"]' }
        ]
      },
      {
        id: 'dropdown',
        ...
        description: 'Select a value in a <select>',
        icon: '⬇️',
        color: 'bg-fuchsia-500',
        category: 'Interaction',
        defaultConfig: { selector: '', value: '' },
        configSchema: [
          { key: 'selector', label: 'Selector', type: 'text', required: true, placeholder: 'select#country' },
          { key: 'value', label: 'Value', type: 'text', required: true, placeholder: 'US' }
        ]
      },
      {
        id: 'screenshot',
        ...
        configSchema: [
          { key: 'filename', label: 'Filename', type: 'text', required: false, placeholder: 'screenshot.png' },
          { key: 'fullPage', label: 'Full Page', type: 'checkbox', required: false, default: false }
        ]
      },
      {
        id: 'click',
        ...
        color: 'bg-green-500',
        category: 'Interaction',
        defaultConfig: { selectorType: 'css', clickType: 'left' },
        configSchema: [
  ...
  getPracticalTemplates(): RPATask[] {
    return [
      ...
      {
        id: 'template_website_auto_navigation',
        name: '🌐 Website Auto Navigation Script',
        description: 'Prebuilt script for automatic website navigation with smooth scrolling',
        category: 'automation',
        icon: '🌐',
        steps: [
          {
            ...
            type: 'navigate',
            name: 'Open Website',
            description: 'Navigate to user-provided website',
            enabled: true,
            config: {
              url: '{WEBSITE_URL}',
              waitForLoad: true
          ...
          },
          {
            ...
            order: 2,
            type: 'scroll',
            name: 'Smooth Scroll Top to Bottom',
            description: 'Smooth scrolling from top to bottom over 30 seconds',
            enabled: true,
            config: {
              scrollType: 'pixels',
          ...
          },
          {
            ...
            order: 3,
            type: 'wait',
            name: 'Mid Scroll Wait',
            description: 'Pause during scrolling',
            enabled: true,
            config: {
              waitType: 'time',
              waitTime: 5000
          ...
          },
          {
            ...
            order: 4,
            type: 'scroll',
            name: 'Smooth Scroll Bottom to Top',
            description: 'Smooth scrolling from bottom to top over 20 seconds',
            enabled: true,
            config: {
              scrollType: 'pixels',
              scrollDirection: 'up',
          ...
          },
          {
            ...
            type: 'wait',
            name: 'Final Wait',
            description: 'Wait 1 minute total run time',
            enabled: true,
            config: {
              waitType: 'time',
              waitTime: 10000
  ...
  private getDefaultTasks(): RPATask[] {
    // Return empty array - users should create their own scripts in RPA Dashboard
    return [];
  }
}
